...
> `TB_COM_TASK_TGT`는 공통, `TB_SYS_ORG`와 `TB_SYS_USER`는 시스템관리, `TB_PRJ_MST`는 프로젝트관리 영역의 물리 테이블이다.
...
| FK_TB_RES_ASSIGN_01 | TB_RES_ASSIGN.PRJ_ID | TB_PRJ_MST.PRJ_ID | DATABASE | Y | RESTRICT/RESTRICT | 인력투입의 프로젝트 참조 무결성 |
